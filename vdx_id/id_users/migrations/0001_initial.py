    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('associated_identity', models.OneToOneField(help_text="Identity linked to user (determines 'my access')", null=True, on_delete=django.db.models.deletion.SET_NULL, to='id_identities.VdxIdentity')),
